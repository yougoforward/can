...
#     --backbone resnet50 --checkname deeplabv3_res50_pascal_aug

#test [single-scale]
python -m experiments.segmentation.test --dataset pascal_aug \
    --model deeplabv3 --aux --dilated --multi-grid --stride 16 --atrous-rates 6 12 18 --base-size 608 --crop-size 520 \
    --backbone resnet50 --resume experiments/segmentation/runs/pascal_aug/deeplabv3/deeplabv3_res50_pascal_aug/checkpoint.pth.tar --split val --mode testval
